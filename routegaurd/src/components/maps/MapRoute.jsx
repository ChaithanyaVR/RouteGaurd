...
const MapRoute = () => {
  ...
  const handleMapClick = (e) => {
    ...
    if (selectedPoint === "origin") {
      ...
      originRef.current.value = `Clicked (${clicked.lat.toFixed(4)}, ${clicked.lng.toFixed(4)})`;
    } else if (selectedPoint === "destination") {
      setDestinationCoords(clicked);
      destinationRef.current.value = `Clicked (${clicked.lat.toFixed(4)}, ${clicked.lng.toFixed(4)})`;
    }
  };
